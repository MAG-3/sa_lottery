...
def lotto_scraper(start_draw, end_draw, save_filename):
    '''Takes in first lotto draw number you want to scrape as well as the last lotto draw number. The filename 
    is the name of the output CSV that will be saved to the machine'''
